...
Strophe.addConnectionPlugin("pubsub", {
    ...
    createNode: function(jid, service, node, options, call_back) {
        ...
        for (var i in options) {
            var key = options[i];
            var options_form_field = Strophe.xmlElement("field", [
                ["var", i]
            ]);
            var options_value = Strophe.xmlElement("value",[]);
            var options_text = Strophe.xmlTextNode(options[i]);
            options_value.appendChild(options_text);
            options_form_field.appendChild(options_value);
            x.appendChild(options_form_field)
        }
        if (options) {
    ...
    subscribe: function(jid, service, node, options, event_cb, call_back) {
        ...
        this._connection.addHandler(event_cb, null, "message", null, null, null,null);
